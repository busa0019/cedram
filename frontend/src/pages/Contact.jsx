...
export default function Contact() {
  ...
  const office = {
    ...
    addressShort: "No 6/8, Ogunnusi road, 3rd Floor, Left Wing, Bamboo Plaza Opposite NNPC Filing Station, Ogunnusi B/Stop, Ojodu, Ikeja",
    addressMapQuery: "No 6/8, Ogunnusi road, 3rd Floor, Left Wing, Bamboo Plaza Opposite NNPC Filing Station, Ogunnusi B/Stop, Ojodu, Ikeja",
    emails: [
      { label: "General inquiries", value: "info@ecrmi.org.ng" },
      { label: "Partnerships", value: "registrarecrmi@yahoo.com" },
      { label: "Research & data requests", value: "registrarecrmi@yahoo.com" },
    ],
    phones: [
      { label: "Office line", value: "+234 803 939 2687" },
      { label: "Support desk", value: "+234 805 591 2022" },
    ],
    hours: [
